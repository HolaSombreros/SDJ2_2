...
/**
 * @param username
 * Adds the user to the existing user list if it's new or sends an error message if the username already exists
 ...
 * */
  ...
  /**
   * @param username
   * removes the user from the current user list
